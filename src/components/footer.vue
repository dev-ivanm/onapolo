<template>
	<footer class="p-6 dark:bg-gray-100 dark:text-gray-800">
		<div class="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4">
			<div class="flex flex-col space-y-4">
				...
				<div class="flex flex-col space-y-2 text-sm dark:text-gray-600">
		...
		<div class="flex items-center justify-center px-6 pt-12 text-sm">
			<span class="dark:text-gray-600">© Copyright 1986. All Rights Reserved.</span>
		</div>
	</footer>
</template>